        ...
        <div class="col">
            <div class="card border-secondary">
                <div class="card-body">
                    ...
                    <form action="{{ route('schooldays.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="mb-3">
                            <label for="title" class="form-label">Title</label>
                            <input type="text" name="title" id="title" class="form-control @if($errors->has('title')) border border-danger @endif"
                                placeholder="Lesson title" aria-describedby="helpId" value="{{old('title')}}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="date" id="date" class="form-control"
                                placeholder="Date" aria-describedby="helpId" maxlength="255" required>
                        </div>
                        <div class="mb-3">
